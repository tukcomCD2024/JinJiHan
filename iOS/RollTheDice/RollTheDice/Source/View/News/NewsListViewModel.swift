...
public class NewsListViewModel: ObservableObject {
    ...
    init(
        newsList: [News] = [
            ...
            .init(title: "해외원정 가던 줄기세포치료 이젠 국내서도 받을 수 있다", date: "2023년2월13일", image: "exampleNews", content: "첨생법 개정안이 이달 1일 국회를 통과해 내년부터 시행된다. 이에 따라 식약처 허가 없이도 안전성·유효성이 확인되면 국내에서도 첨단재생의료 치료가 허용되고 모든 질환에 대한 임상연구가 가능해졌다. ", isBookmarked: true),
            .init(title: "홀로 선 자립준비청년, 배곯지 않게…우체국, 매일 식비 지원", date: "2023년2월13일", image: "exampleNews", content: "과학기술정보통신부 우정사업본부는 사회에 첫발을 내딛는 자립준비청년이 건강한 사회구성원으로 성장하도록 식비를 지원하는 '우체국 청년밥심 스타트 온(溫)' 사업을 확대 추진한다고 14일 밝혔다.", isBookmarked: false),
