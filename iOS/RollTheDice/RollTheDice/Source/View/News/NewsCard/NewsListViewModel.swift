...
//    
//    func newsToViewModel(_ list: NewsResponse) {
//        self.newsResponse = list
//    }
//}

//extension NewsListViewModel {
//    public func getAllNewsData(page: Int, size: Int) {
//        print("news : 요약 뉴스 전체 조회")
//        
//        let accessToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJBY2Nlc3NUb2tlbiIsImV4cCI6MTcxMTQ3NjEzNywiZW1haWwiOiJjaGVueWVvbmp5QGRhdW0ubmV0In0.bEstO5tRBZL1-cah-hEfF270DA37UNQ3gm0txLoDxaGuPNYTfNcDA1UbiNaVIWvMwnw7RQoS8g4WlJrv_Holsw"
//        
